      ...
      items: [
        ...
        },
        {
          ...
          */
          ...
          // Points at /delete-account for the detail rather than restating all of it: two
          // copies of a deletion commitment is two things to keep true of the shipped RPC.
          // Both self-service routes are named because both exist — `/profile` and the
          // owner settings hub each render `DeleteAccountCard` — so saying only "in the app"
          // would understate what this site itself offers.
          body: `delete your account yourself — in the app under Settings, or on this site from your profile — or email ${legal.contactEmail} if you can no longer sign in, and we will do it within ${legal.deletionDays} days. See /delete-account for exactly what is removed and what a salon keeps without your name on it.`,
        },
      ],
    },
    {
