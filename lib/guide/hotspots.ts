...
export const HOTSPOTS: Record<string, HotspotBox> = {
  ...
  "owner/phone/06-insights-charts": { x: 3.3, y: 100, w: 91.3, h: 0 },
  ...
  "owner/phone/10-settings": { x: 3.3, y: 98.6, w: 39.4, h: 1.4 },
