      ...
      <Marquee speed={1.6}>
        {services.map((service) => (
          <span key={service} className="px-1.5 py-4 sm:py-5">
            <span className="ring-hairline text-ink text-title inline-flex items-center gap-2 rounded-full px-4 py-2 font-medium whitespace-nowrap ring-1 ring-inset">
