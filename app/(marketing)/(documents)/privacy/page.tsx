 ...
 *
 * **The header, the footer, the 46rem measure and the clearance under the fixed bar
 * are all in `(documents)/layout.tsx` now.** They were written out here when this was
 * the only public document; three more have joined it, and one shell for four pages is
 * what stops them drifting apart. Nothing about what renders changed — the layout
 * carries this page's own numbers.
 */
